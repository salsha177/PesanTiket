...
<body class="g-sidenav-show bg-gray-100">
	<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-left ms-3" id="sidenav-main">
		<div class="sidenav-header">
			...
			<a class="navbar-brand m-0" href="<?= base_url('User/Dashboard') ?>">
				<img src="<?= base_url() ?>assets/img/logos/logo.png" class="navbar-brand-img h-100 justify-center" alt="...">
			</a>
		</div>
			...
			<ul class="navbar-nav">
				...
				<!-- <li class="nav-item">
					<a class="nav-link" href="<?= base_url('Admin/Pemesanan'); ?>">
						...
						<span class="nav-link-text ms-1">Pemesanan Tiket</span>
					</a>
				</li> -->
				<li class="nav-item">
				...
				<li class="nav-item">
					<a class="nav-link" href="<?= base_url('Admin/Data_ka'); ?>">
						<div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
						...
						<span class="nav-link-text ms-1">Data Kereta Api</span>
					</a>
				</li>
			</ul>
		</div>
